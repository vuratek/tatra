...
export class Drag extends PointerInteraction {
    public coordinate_ : Coordinate| null = null;
    public cursor_ : string | undefined = 'pointer';
    public previousCursor_ : string | undefined = undefined;
    public feature_ : Feature | null = null;
...
export class DownUpInteraction extends PointerInteraction {
    constructor() {
        super({
